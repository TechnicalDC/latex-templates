...
\begin{itemize}
   ...
   \item Proficiently deployed various programs leveraging advanced tools like
      YAB and CVC, ensuring smooth implementation and seamless integration with
      existing systems.
   \item Designed and deployed multiple QRF programs leveraging Platform API to
	...
	\item Worked on the creation of OOABL Classes and Interfaces for QAD AUX App
		and performed the ant deployment in the environment.
   \item Executed development and integration workflows via SVN and provided
      technical support by troubleshooting Linux server issues.
   \item Led a team of developers, providing guidance, task allocation, and
...
\begin{itemize}
   \item \textbf{Programming Languages:} Progress 4GL, OOABL, Python, Golang, Lua, Typescript, Bash, MySQL, Java.
   \item \textbf{Framework:} QAD Reporting Framework (QRF), Django, Flask, jQuery, Hugo, Springboot.
   \item \textbf{Environments:} QAD SE, QAD EE, QAD MfgPro, QAD AUX.
   \item \textbf{Dev Tools:} Linux, Unix, Git, Jira, Service Now, Vim/Vi, Tmux, Soap UI, Postman, Subversion.
\end{itemize}

\CvSection{Certifications}

\CvEntry{QRA Developer Practitioner}
{April, 2025}
{QAD Inc.}
{}
