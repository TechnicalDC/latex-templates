...
#experience(
  place: "Aliter Business Solutions Private Limited",
  title: "QAD Technical Consultant",
...
#experience(
  place: "Marvel Data Services LLP",
  title: "Data Entry Operator",
  time: [Aug, 2018 - April, 2019],
  location: "Mumbai, India"
)[
  - Worked on conversion of the Hard Copy Data to digital format, allowing data
    to be processed further for various applications.
  - Assisted other teammates on the various conversion tasks.
]
...
#certification(
  place: "QAD Inc",
  title: "Enterprise Platform Developer Certification",
  time: [April, 2024],
  location: none
)[]
...
#certification(
  place: "QAD Inc",
  title: "Cloud Platform Development Certification",
  time: [Jan, 2025],
  location: none
)[]
...
#certification(
  place: "QAD Inc",
  title: "Customer Version Control (CVC) Certification",
  time: [Jun, 2022],
  location: none
)[]
...
#certification(
  ...
  title: "NDG Linux Essentials Certification",
  time: [April, 2021],
  location: none
)[]
...
#education(
  place: "M.G.M Jr. College of Science",
...
#education(
  place: "Father Agnel's English School",
